...
public class AssetUtil {
	...
	public static void main(String[] args) {
		...
		System.out.println("Total of all assets: " + totalBondValues(assets));
		System.out.println("Total of all assets: " + totalStockValues(assets));
	}
}
